...
【文字数】必ず140文字以上180文字以下で生成すること（140文字未満・180文字超は厳禁）。
...
ルール絶対遵守: 【トーン：シンプル】などのメタ情報や前置きテキストは含めず、純粋な口コミテキストのみを出力してください。"""
        ...
        if b_type in SALON_TYPES:
            ...
            _COMMON_RULES = (
                ...
                "例3: 縮毛矯正、ドライカットをしていただいています。これがないと生きていけない！ばっちり綺麗なストレートになりました！ツヤツヤ、さらさらの髪質改善です！！\n"
                "例4: トリートメントとカラーをやってもらいました。カラーもドンピシャの色に染めてもらえました！トリートメントも一緒にやってもらいましたが、自分の髪がこんなトゥルントゥルンになるんだと驚きと感動で、お店を出たあともしばらく触ってました笑\n"
                "例5: アーチ梅田店で部分カラーとエクステ取り外しとブローをしていただきました。早くて色もいい感じで、3000円以上のメニュー選択したので取り外しは無料で嬉しかったです。\n"
                "例6: いつもざっくりとした希望しかお伝えしていないのですが、扱いやすいカラーやカットにしていただいています！次回予約特典のシャンプーも嬉しいです。美容師さんたちの落ち着いた雰囲気も、私は過ごしやすいです。\n"
                "例7: チャットgptで大阪エリアの美容室調べたら出てきたので来ました！初めての縮毛矯正でしたので、分からないところや質問など全て答えていただき安心して施術受けることができました！終わったあと自分の髪の毛の悩みが全部無くなって凄く嬉しかったです！\n"
                "例8: チルヘアさんには、もう2年くらいヘアケアしていただいています！隣の人間国宝さんの店長さんのくせ活カットのおかげで、自分のくせ毛は個性！と愛でられるようになりました＾＾\n"
                "例9: 初めて来てブリーチなしのWカラーをしてもらったのですが、理想の色になったのですごく満足してます！また、次カラーする時も行きます！\n"
                "例10: 毎回丁寧なカウンセリングで素敵な髪型にしてくださいます☺️✂️過去一短く切ったショートカットもお任せしましたが、気に入っていますし周りからも好評でした🤍遅い時間まで対応してくださるので仕事終わりなど本当にありがたいです！\n"
                "例11: 葉山さんにカラーと前髪カットをしてもらいました！カラーの要望を伝えるといくつか提案してくれ、その中から選びました！髪の毛の負担が減るように染めてくれて色もいい感じ🫶前髪は、私の理想に近づくように私の意見を何度も聞きながら切ってくれました✂︎\n"
                "例12: いつもMiranさんにお願いしています✨️成人式だったので1ヶ月前からハイトーン準備して、前日に希望カラーにして貰いました🩶細かいところはいつもお任せですが、毎回ドンピシャの仕上がりですし、何より色落ちが綺麗で最高です✨️\n"
                "例13: 理想のカラーになるし、髪染めるたびにかわいい髪色を更新してくれて色落ちも最高にかわいい🩷店内の雰囲気もめっちゃくちゃいい！！こんなおんなじ美容室に通ってるのははじめてかも！？レベルで最高の仕上がりでした！\n"
                "例14: 個室の雰囲気もよく、マンツーマンで他の人の目もきにならず、落ち着いた環境の中施術していただけて良かったです。朝起きて鏡を見て、爆発してないサラサラな毛に感動しました！\n"
                "例15: 雑談も楽しくさせて頂いたのであっという間の施術だったので家からも近いですしこれからも通おうと思います！\n"
                "例16: 淀屋橋の美容室で1番好きな美容室です！！こだわり強めなんですが、いつも好みとかわかってくれてるのでカラーとかは基本的に全部任せてます♡Mでカラーしてもらったら毎回知人に褒めてもらえるので本当にお気に入りのサロンです😌\n"
                "例17: ほぼ担当者マンツーマンで寄り添ってくれますよ。エレベーターでは2Fにとまらないので入り口入ってすぐ左の階段を使用してください。\n"
                "例18: 初白髪ぼかしカラーしました。今までの白髪染めを除去することから始まり、これからどう変わっていくのかとても楽しみです！丁寧な説明と何でも言いやすい雰囲気に安心しました。\n"
                "例19: 対応いただいた方(男性)の人柄が良かったです！あと、キャッシュレスで支払いができたのが1番良かったです！(現金支払のお店が多いので助かります！)ただ、場所が分かりずらいので-1😅\n"
                "例20: 友人に紹介されて利用してます。男性スタッフ2人にカットカラーをして頂きましたが、どちらの方もとても丁寧にカウンセリングをしてくださり技術もあるので悩みを解消してくれる仕上がりに納得です！また、次もよろしくお願いします。\n\n"
                "口コミ文章のみを出力してください。"
            )
            ...
            if b_type == "メンズサロン":
                user_prompt = (
                    ...
                    + _SURVEY +
                    "【口コミ作成のルール】\n"
                    "- 必ず140文字以上180文字以下で作成すること（140文字未満・180文字超は厳禁）\n"
