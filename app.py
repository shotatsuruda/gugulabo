...
ルール絶対遵守: 【トーン：シンプル】などのメタ情報や前置きテキストは含めず、純粋な口コミテキストのみを出力してください。"""
        ...
        if b_type in SALON_TYPES:
            ...
            _COMMON_RULES = (
                ...
                "「友人に勧められて」「ずっと気になってたサロンで」「引っ越してきてから探してて」「髪のダメージがひどくて」「記念日のご褒美に」「3回目の来店です」「半年ぶりに来たら」「初めての縮毛矯正で不安だったけど」「ずっと悩んでた髪質を相談してみた」など\n\n"
