...
- コスパ・価格への言及を入れる
- アクセス・立地・駐車場などに触れる
- 効果・体感（「翌日も楽だった」など）を中心に書く

【書き出し】「先日」「初めて」「こちらの」の連続使用禁止。以下のような多様な書き出しを使う：
「友人に勧められて〜」「ずっと気になっていた〜」「仕事帰りに〜」「予約が取れたので〜」「口コミを見て〜」「思い切って〜」「近くを通りかかって〜」「記念日に〜」「リピートで〜」「〇回目の来店です」など
...
【禁止事項】
- 同じ文章構成・語順・言い回しを繰り返さない
- 「とても」「非常に」を連続使用しない
- 綺麗すぎる文章にしない。自然なばらつきを出す
